...
While completing this worksheet, you will need to type into the markdown file itself ("Week One.Rmd"), but it will be easiest to read the worksheet html file ("Week One.html"). Markdown files are converted to HTML files through a process called "knitting". You can knit the .Rmd file into an HTML file in RStudio using the "Knit" button. Each week, you will download the .Rmd and .html file associated with that week's lab assignment. You will edit your own copy of the .Rmd file, filling in answers (typically as chunks of code) under each of the exercises. You will then knit your completed .Rmd file, check that your file looks correct, and then submit both your final .Rmd file and knitted .html file. 

To build up your intuition about how markdown files are made, it will be good to flip back and forth between the .Rmd file and the .html file. When you see red, bold text that says "Exercise", there is a practice question to answer. Please complete this question in the .Rmd file. When you've completed the worksheet, please save a new copy of the .Rmd file with your initials and knit a new HTML file. Upload both files to canvas. 
